...
public class MainActivity extends DaggerAppCompatActivity
    ...
    private void insertMockData() {
        ...
        String[] trivia = getResources().getStringArray(R.array.trivia);
        ...
        Movie movie6 = new Movie(null, movies[5], getString(R.string.desc),
                storyLines[5], trivia[0], R.drawable.guardians_of_the_galaxy, CATEGORY_COMEDY, false, durationTime[5]);
        Movie movie7 = new Movie(null, movies[6], getString(R.string.desc),
                storyLines[6], trivia[0], R.drawable.jumanji, CATEGORY_COMEDY, false, durationTime[6]);
        Movie movie8 = new Movie(null, movies[7], getString(R.string.desc),
                storyLines[7], trivia[0], R.drawable.series_of_unfortinate_events, CATEGORY_COMEDY, false, durationTime[7]);
        Movie movie9 = new Movie(null, movies[8], getString(R.string.desc),
                storyLines[8], trivia[0], R.drawable.lego, CATEGORY_COMEDY, false, durationTime[8]);
        Movie movie10 = new Movie(null, movies[9], getString(R.string.desc),
                storyLines[9], trivia[0], R.drawable.deadpool, CATEGORY_COMEDY, false, durationTime[9]);

        Movie movie11 = new Movie(null, movies[10], getString(R.string.desc),
                storyLines[10], trivia[0], R.drawable.back_to_the_future_the_game, CATEGORY_SCI_FI, false, durationTime[10]);
        Movie movie12 = new Movie(null, movies[11], getString(R.string.desc),
                storyLines[11], trivia[0], R.drawable.doctor_who, CATEGORY_SCI_FI, false, durationTime[11]);
        Movie movie13 = new Movie(null, movies[12], getString(R.string.desc),
                storyLines[12], trivia[0], R.drawable.twelve_monkeys, CATEGORY_SCI_FI, false, durationTime[12]);
        Movie movie14 = new Movie(null, movies[13], getString(R.string.desc),
                storyLines[13], trivia[0], R.drawable.x_files, CATEGORY_SCI_FI, false, durationTime[12]);
        Movie movie15 = new Movie(null, movies[14], getString(R.string.desc),
                storyLines[14], trivia[0], R.drawable.fringe, CATEGORY_SCI_FI, false, durationTime[12]);

        Movie movie16 = new Movie(null, movies[15], getString(R.string.desc),
                storyLines[15], trivia[0], R.drawable.incredibles, CATEGORY_ANIMATION, false, durationTime[13]);
        Movie movie17 = new Movie(null, movies[16], getString(R.string.desc),
                storyLines[16], trivia[0], R.drawable.rick_and_morty, CATEGORY_ANIMATION, false, durationTime[14]);
        Movie movie18 = new Movie(null, movies[17], getString(R.string.desc),
                storyLines[17], trivia[0], R.drawable.big_hero, CATEGORY_ANIMATION, false, durationTime[14]);
        Movie movie19 = new Movie(null, movies[18], getString(R.string.desc),
                storyLines[18], trivia[0], R.drawable.frozen, CATEGORY_ANIMATION, false, durationTime[14]);
